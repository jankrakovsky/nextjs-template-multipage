...
export default function Home() {
	return (
		<div className="Home">
			<div className="Home-start min-h-[900px] h-screen py-2 bg-primary-flamingo text-white">
				<TwoColumns>
			...
			<div className="Home-features min-h-[900px] sm:h-screen py-2 bg-white grid content-center">
				<div className="m-auto sm:w-min text-center">
					<h5 className=" text-primary-red">Nominavi suavitate</h5>
					<h2 className="sm:w-max">Offendit persecuti</h2>
